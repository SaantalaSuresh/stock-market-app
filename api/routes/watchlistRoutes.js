...
// // POST route to add a stock to the user's watchlist
...
// // GET route to retrieve all stocks for a specific user
...
// // router.get('/', async (req, res) => {router.post('/', async (req, res) => {
// //   try {
// //     const { userId, stock } = req.body;
// //     console.log('Received data:', req.body);
...
// router.delete('/stocks', async (req, res) => {
//   try {
//     const { userId, stockId } = req.body; // Extract from the request body
...
//     // Filter out the stock that needs to be deleted
//     watchlist.stocks = watchlist.stocks.filter((stock) => stock._id.toString() !== stockId);
