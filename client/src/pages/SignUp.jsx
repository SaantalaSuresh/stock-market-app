    ...
    <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 to-blue-200 p-5'>
      <div className='bg-white p-8 rounded-lg shadow-xl w-full max-w-md'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-3'>
          ...
          <button
            disabled={loading}
            className='bg-blue-600 text-white p-3 rounded-lg uppercase font-semibold tracking-wide hover:bg-blue-700 transition-colors duration-300 disabled:opacity-70'
          >
