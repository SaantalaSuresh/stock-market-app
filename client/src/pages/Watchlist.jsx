...
// // //   const userId = "66c1bcacfc2d4144ced12c8d"
...
// // //     setError(null);
// // //     try {
// // //       await axios.post('/api/watchlist', { userId, stock: newStock });
...
// // //     setError(null);
// // //     try {
// // //       await axios.put(`/api/watchlist/${selectedStock._id}`, { userId, updatedStock: newStock });
...
// // //               <Button variant="outline-warning" onClick={() => { setSelectedStock(stock); setNewStock(stock); setIsEditing(true); setShowModal(true); }}>
// // //                 <FaEdit />
// // //               </Button>
// // //               <Button variant="outline-danger" onClick={() => handleDeleteStock(stock._id)}>
// // //                 <FaTrash />
// // //               </Button>
// // //             </div>
// // //           </div>
...
//               <span className="stock-name">{stock.name}</span>
//               <span className="stock-symbol">({stock.symbol})</span>
//               <span className="stock-datetime">{format(new Date(stock.datetime), 'MMMM d, yyyy H:mm')}</span>
//             </div>
//             <div className="stock-actions">
//               <Button variant="outline-warning" onClick={() => { setSelectedStock(stock); setNewStock({ name: stock.name, symbol: stock.symbol, datetime: stock.datetime }); setIsEditing(true); setShowModal(true); }}>
//                 <FaEdit />
